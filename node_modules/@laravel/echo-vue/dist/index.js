import { ref as v, watch as P, onMounted as y, onUnmounted as C } from "vue";
import F from "pusher-js";
class I {
  constructor() {
...
class w extends m {
  ...
  encryptedPrivateChannel(e) {
    return this.channels["private-encrypted-" + e] || (this.channels["private-encrypted-" + e] = new B(
      this.pusher,
      "private-encrypted-" + e,
      this.options
   ...
   */
  presenceChannel(e) {
    return this.channels["presence-" + e] || (this.channels["presence-" + e] = new q(
      this.pusher,
      "presence-" + e,
      this.options
...
class Q {
  ...
  connect() {
    if (this.options.broadcaster === "reverb")
      ...
      this.connector = new X(this.options);
    else if (this.options.broadcaster === "null")
      this.connector = new R(this.options);
    else if (typeof this.options.broadcaster == "function" && H(this.options.broadcaster))
...
const W = () => {
...
}, p = () => W(), j = (n) => Array.isArray(n) ? n : [n], h = {}, Y = (n) => {
  if (h[n.id])
  ...
  h[n.id] && (h[n.id].count -= 1, !(h[n.id].count > 0) && (delete h[n.id], e ? p().leave(n.name) : p().leaveChannel(n.id)));
};
function k(n, e = [], t = () => {
}, s = [], i = "private") {
  const r = v(t), c = v(!1);
...
const ee = (n, e = () => {
  ...
  const i = k(
    ...
    s,
    "private"
  ), r = j(t).map((o) => o.includes(".") ? [o, o.replace(/\./g, "\\")] : [o, o.replace(/\\/g, ".")]).flat(), c = v(!1), d = (o) => {
    c.value && (r.length === 0 || r.includes(o.type)) && e(o);
  }, u = () => {
    c.value || (i.channel().notification(d), c.value = !0);
  }, f = () => {
    c.value && (i.channel().stopListeningForNotification(d), c.value = !1);
  };
  return y(() => {
    u();
  }), C(() => {
  ...
  let s;
  y(() => {
    e && n(t.connectionStatus()), s = t.connector.onConnectionChange(n);
  }), C(() => {
    s?.();
  });
}, ie = () => {
  const n = p(), e = v(n.connectionStatus());
  return $((t) => {
    e.value = t;
  }), e;
}, re = () => {
  const n = p(), e = v(n.socketId());
  return $(() => {
    e.value = n.socketId();
  }, !1), e;
};
export {
  Z as configureEcho,
  p as echo,
  J as echoIsConfigured,
  ie as useConnectionStatus,
  k as useEcho,
  se as useEchoModel,
